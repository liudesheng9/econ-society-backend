...
use crate::api::model::{NewResearcherCard, ResearcherCard};
use crate::api::researcher_card::create_researcher_card;
use crate::db::Connection;
use crate::google_scholar::model::{GoogleScholar, GoogleScholarPubListed, PublicationFilled};
...
pub async fn google_scholar_update_endpoint(
    ...
    let scholar_publisted = GoogleScholarPubListed::from_GoogleScholar(scholar.0);
        ...
        .first(&mut conn.0)
    {
        ...
        Err(diesel::result::Error::NotFound) => {
            ...
            let result = create_researcher_card(conn, Json(newresearcher_card))?;
            Ok(result)
        }
